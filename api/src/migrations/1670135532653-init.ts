...
export class init1670135532653 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "videos" ("id" BIGSERIAL NOT NULL, "link" character varying NOT NULL, "title" character varying NOT NULL, "description" text NOT NULL, "video_id" character varying NOT NULL, "image_url" character varying NOT NULL, "video_urls" jsonb NOT NULL DEFAULT '[]', "duration" character varying, "user_id" uuid, CONSTRAINT "PK_e4c86c0cf95aff16e9fb8220f6b" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_0b143ebc78208631fad3c886de" ON "videos" ("video_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_dc72d97ea7e7f484c8ea32049c" ON "videos" ("title") `);
        await queryRunner.query(`CREATE TABLE "categories" ("id" BIGSERIAL NOT NULL, "category_id" integer, "name" character varying NOT NULL, "slug" character varying NOT NULL, "description" character varying, "image_url" character varying, "user_id" uuid, CONSTRAINT "PK_24dbc6126a28ff948da33e97d3b" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "channels" ("id" BIGSERIAL NOT NULL, "name" character varying NOT NULL, "url" character varying NOT NULL, "image" character varying NOT NULL, "user_id" uuid, CONSTRAINT "PK_bc603823f3f741359c2339389f9" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "music" ("id" BIGSERIAL NOT NULL, "link" character varying NOT NULL, "title" character varying NOT NULL, "description" text NOT NULL, "video_id" character varying NOT NULL, "image_url" character varying NOT NULL, "video_urls" jsonb NOT NULL DEFAULT '[]', "duration" character varying, "user_id" uuid, CONSTRAINT "PK_c92b010dd889692dd54286f75e2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_887c39967066a1565e3c7f9d81" ON "music" ("video_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_691e99699b0d2dfaaa7a6a83c5" ON "music" ("title") `);
        await queryRunner.query(`CREATE TABLE "files" ("id" SERIAL NOT NULL, "file_id" integer, "post_id" integer, "title" character varying, "link" character varying, "url" character varying, "s3_key" jsonb, "bucket" jsonb, "mime" jsonb, "comment" text, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_6c16b9093a142e0e7613b04a3d9" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "websites" ("id" BIGSERIAL NOT NULL, "name" character varying NOT NULL, "url" character varying NOT NULL, CONSTRAINT "PK_da80e50ae0d986d43c9eb80ab70" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "music_categories_categories" ("musicId" bigint NOT NULL, "categoriesId" bigint NOT NULL, CONSTRAINT "PK_a373b4eb5e99f05315acf9c95ba" PRIMARY KEY ("musicId", "categoriesId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_4b644c424deba450c427924c1e" ON "music_categories_categories" ("musicId") `);
        await queryRunner.query(`CREATE INDEX "IDX_b0b1fbf740aee8bfaab72ee232" ON "music_categories_categories" ("categoriesId") `);
